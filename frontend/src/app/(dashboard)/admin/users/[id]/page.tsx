      ...
      <div>
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-accent-amber px-4 py-2.5 text-sm font-semibold text-surface-deep transition-all duration-200 hover:shadow-glow hover:scale-[1.02] active:scale-[0.98] motion-reduce:hover:scale-100 motion-reduce:active:scale-100 focus:outline-none focus-visible:ring-[3px] focus-visible:ring-[var(--accent-amber-glow)]"
          >
            Edit user
          </Link>
        </div>
